                        ...
                        <div class="card rounded-0 m-0 shadow-none bg-transparent mb-0">
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="form-body">
                                        <form method="POST" action="{{ route('reset-password-request-action') }}">
                                            @csrf

                                            <div class="row mb-3">
                                                <label for="nim" class="col-md-4 col-form-label text-md-end">NIM
                                                    <br>(tanpa titik)</label>

                                                <div class="col-md-8">
                                                    <input id="nim" type="text"
                                                        class="form-control @error('nim') is-invalid @enderror"
                                                        name="nim" value="{{ $nim ?? old('nim') }}" required
