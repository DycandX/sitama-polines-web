            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('jadwal-bimbingan.update', $bimbingan->bimbingan_magang_id) }}" method="post" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tgl_kegiatan"
                                        ...
                                        placeholder="Pilih Tanggal" value="{{ $bimbingan->tgl_kegiatan }}">
                                    @error('tgl_kegiatan')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kegiatan"
                                        ...
                                        placeholder="Kegiatan yang dilakukan" value="{{ $bimbingan->kegiatan }}">
                                    @error('kegiatan')
                                        <div class="invalid-feedback" role="alert">
                                            <span>{{ $message }}</span>
                                        </div>
