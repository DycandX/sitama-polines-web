            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('ujian-sidang.storePenguji', $infoMhs->ta_sidang_id) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                ...
                                @foreach ($nilai_penguji as $nilai)
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <select name="unsur[{{ $nilai->nilai_id }}]"
                                                ...
                                                @for ($i = 100; $i >= 1; $i--)
                                                    <option
                                                        value="{{ $i }}"{{ isset($nilai_penguji_saved[$nilai->nilai_id]) && $i == $nilai_penguji_saved[$nilai->nilai_id] ? " selected='selected'" : '' }}>
                                                        {{ $i }}</option>
                                                @endfor
                                            </select>
                                        </div>
                            ...
                            <div class="card-footer">
                                <a class="btn btn-info confirm-nilai mr-2"><i class="fa fa-save"></i>
                                    Simpan</button>
