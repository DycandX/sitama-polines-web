                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="col-md-6 text-end">
                                                <a href="{{ route('reset-password-request') }}">Lupa password?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid text-center">
                                                    <a href="/google/redirect" class="btn btn-outline-primary">
                                                        <img src="/assets/images/google-logo.png" width="24px"
                                                            style="margin-right: 8px;">
                                                        Masuk dengan Email Polines
                                                    </a>
                                                    <div style="mt-2">
                                                        <small><i>(untuk Dosen)</i></small>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="col-12">
