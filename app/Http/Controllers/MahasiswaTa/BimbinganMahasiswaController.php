...
class BimbinganMahasiswaController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (!isset($dataTa)) {
            ...
            return view('bimbingan-mahasiswa.index', compact('logCollect', 'mahasiswa', 'masterJumlah', 'logCollectJumlah'));
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bimbingan-mahasiswa.index');
        } catch (\Throwable $th) {
    ...
    public function show($id)
    {
        ...
        return view('bimbingan-mahasiswa.show', compact('mahasiswa', 'bimbLog'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($bimbLog->bimb_status == 0 && $mahasiswa->ta_id == $batas->ta_id) {
            return view('bimbingan-mahasiswa.edit', compact('mahasiswa', 'bimbLog', 'batas'));
        } else {
